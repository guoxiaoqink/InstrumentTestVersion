...
public class WeekDayView extends View {
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#00CCE4F2");
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#97c8cd");
    //周一到周五的颜色
    private int mWeedayColor = Color.parseColor("#999999");
    //周六、周日的颜色
