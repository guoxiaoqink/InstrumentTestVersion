...
public class MediaMetadataRetriever {
  ...
  private static boolean loadFFmpeg_native(String ffmpegPath) {
    return false;
  }
   ...
   * null on failure.
   */
  public String extractMetadata(String keyCode) throws IllegalStateException {
    return null;
  }

  public Bitmap getFrameAtTime(long timeUs) throws IllegalStateException {
    return null;
  }
   ...
   */
  public byte[] getEmbeddedPicture() throws IllegalStateException {
    return new byte[0];
  }
